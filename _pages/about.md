...
I am a PhD student in Computer Science at the University of California, Los Angeles (UCLA), advised by [Prof. Wei Wang](https://web.cs.ucla.edu/~weiwang/) at the Scalable Analytics Institute (ScAI). Before joining UCLA, I obtained my M.S. in Data Science from Peking University (advised by [Prof. Xiaojun Wan](https://wanxiaojun.github.io/)) and my B.S. in Computer Science from UESTC (Rank 1st out of 217, GPA 3.97/4.0).
...
- **2026** — One paper accepted at **ICLR 2026** (Preference Leakage in LLM-as-a-judge)
- **2025** — Papers accepted at ACL 2025, NAACL 2025 (Findings), and EMNLP 2025 (Findings)

## Selected Publications

1. **Stop When Enough: Adaptive Early-Stopping for Chain-of-Thought Reasoning** — ACL 2026  
   **Renliang Sun**\*, Wei Cheng\*, Dawei Li\*, Haifeng Chen, Wei Wang  
   [Paper](https://arxiv.org/pdf/2510.10103)

2. **Preference Leakage: A Contamination Problem in LLM-as-a-judge** — ICLR 2026  
   Dawei Li\*, **Renliang Sun**\*, Yue Huang, Ming Zhong, Bohan Jiang, Jiawei Han, Xiangliang Zhang, Wei Wang, Huan Liu  
   [Paper](https://arxiv.org/pdf/2502.01534)
